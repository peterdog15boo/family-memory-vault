...
export const enUS = {
  ...
  mediaUi: {
    ...
    captionAdd: "Add a caption",
    captionSave: "Save",
    captionCancel: "Cancel",
    captionSaving: "Saving…",
    captionSaveError: "Couldn’t save caption.",
    captionEditedBy: "Edited by {name}",
    captionPlaceholder: "Write a short caption…",
    captionCharCount: "{count}/{max}",
  },
  dashboard: {
    eyebrow: "Your vault",
    ...
    tileNavAria: "Library shortcuts",
    tileAria: "{title}, {subtitle}",
    tilePhotosSubtitle: "Your library",
    tileMemoriesSubtitle: "Albums and stories",
    tileSharedTitle: "Shared with me",
    tileSharedSubtitle: "Family photos",
    tilePeopleSubtitle: "Faces you know",
    tilePhotosAlt: "Printed family photos and warm table light",
    tileMemoriesAlt: "Family gathered warmly around a shared meal",
    tileSharedAlt: "Siblings sharing a quiet, joyful moment",
    tilePeopleAlt: "Grandparents and family faces in soft light",
    betaSwitchChip: "Beta: you can switch plans free",
    journeyStripAria: "Photo journey stats. Open details.",
    journeyStripHint: "View journey",
    journeyStatPhotos: "Photos",
    journeyStatLevel: "Level",
    journeyStatBadges: "Badges",
    journeyStatMemories: "Memories",
    journeyStatValueAria: "{label}: {value}",
    journeyStepZero: "Add a few photos to start your journey.",
  },
  completeness: {
    eyebrow: "Getting started",
  ...
  memories: {
    ...
    makeMovieNeedMediaShort: "Add photos first",
    ...
    slideshowNeedMedia: "Add a few photos before playing a slideshow.",
  ...
  people: {
    ...
    rename: "Rename",
    storyTitle: "Story",
    storyEmpty: "Add captions on photos of {name} to build their story.",
    storyUpdatedFrom: "Updated from {count} captions",
    storyRefresh: "Refresh",
    storyGenerate: "Generate story",
    storyRefreshConfirm:
      "Replace the current story with a new one from today’s captions?",
    storyRefreshError: "Couldn’t update the story. Try again.",
