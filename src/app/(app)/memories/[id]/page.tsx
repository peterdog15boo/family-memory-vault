...
type PageProps = {
  ...
  searchParams: Promise<{ edit?: string; createMovie?: string; addPhotos?: string }>;
};
...
export default async function MemoryDetailPage({
  ...
  const { edit, createMovie, addPhotos } = await searchParams;
  ...
  return (
    <MemoryDetailView
      ...
      startAddPhotos={isOwner && addPhotos === "1"}
    />
  );
}
